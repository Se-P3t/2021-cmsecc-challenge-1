...
parser.add_argument('--experiments', type=int, dest="experiments",
...
#time python recover_initial_state.py 2147483647 "257, 0, 0, 0, 1048576, 0, 0, 0, 0, 0, 2097152, 0, 0, 131072, 0, 32768" 150 27 --category 1 --level 7 --verbose 5 --threads 3 --sieve
...
$ time python recover_initial_state.py 2147483647 "257, 0, 0, 0, 1048576, 0, 0, 0, 0, 0, 2097152, 0, 0, 131072, 0, 32768" 200 27 --category 1 --level 7 --verbose 2 --threads 3 --sieve
"""
